...
void props::bone_properties::add_or_delete_constraint(mdl::project& proj, ui::canvas& canv) {
...
props::bone_properties::bone_properties(const current_canvas_fn& fn, ui::selection_properties* parent) :
...
void props::bone_properties::populate(mdl::project& proj) {
    layout_->addWidget(
...
bool props::bone_properties::is_multi(const ui::canvas& canv) {
    return canv.selected_bones().size() > 1;
}

void props::bone_properties::set_selection_common(const ui::canvas& canv) {
...
void props::bone_properties::set_selection_multi(const ui::canvas& canv) {
    name_->hide();
    nodes_->hide();
    constraint_box_->hide();
...
void props::bone_properties::set_selection_single(const ui::canvas& canv) {
    name_->show();
    nodes_->show();
...
void props::bone_properties::lose_selection() {
    if (constraint_box_) {
        constraint_box_->hide();
    }
}
