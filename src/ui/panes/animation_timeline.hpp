...
namespace ui::pane {
    ...
    class animation_timeline : public QDockWidget {
        ...
        struct gesture {
            ...
            sm::point pivot;
            QPointF press;
            double previous_angle = 0, total_angle = 0;
            bool moved = false;
        };
        ...
        void gesture_press(QPointF position);
        void gesture_move(QPointF position);
        void gesture_release(QPointF position);
        void tick();
